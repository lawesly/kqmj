...
<!--    <link href="{{data.favicon}}" type="image/x-icon" rel="shortcut icon">-->
    ...
    <link href="/application/views/static/vendor/datepicker/bootstrap-datepicker3.min.css" rel="stylesheet">
        ...
        <div class="navbar-default sidebar" style="margin-top:42px" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="?/anomaly_app/">异常申请</a>
                    </li>
                    <li>
                        <a href="?/wr/">作息管理</a>
                    </li>
                    <li>
                        <a href="?/userinfo/">员工信息</a>
                    </li>
                    <?php if($username == 'ch'): ?>
                        <li>
                            <a href="?/notice_user/">异常通知</a>
                        </li>
                    <?php endif; ?>
                    <?php if($gid == 1): ?>
                        <li>
                            <a href="#">系统配置<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="?/users/">用户管理</a>
                                    <a href="?/carlicrec/">车牌管理</a>
                                    <a href="?/vehiclerecord/">车辆通行记录</a>
                                </li>
                            </ul>
                        </li>
                    <?php endif; ?>
