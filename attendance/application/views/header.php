            ...
            <div class="navbar-default sidebar" style="margin-top:50px" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="?/main/" id="index"><i class="fa fa-home fa-fw"></i> 首页</a>
                        </li>

                        <li>
                            <a href="?/attendance/" id="attendance"><i class="fa fa-table fa-fw"></i> 考勤管理</a>
                        </li>
                        <li>
                            <a href="?/anomaly_app/" id="anomaly_app"><i class="fa fa-edit fa-fw"></i> 异常申请</a>
                        </li>
                        <li>
                            <a href="?/wr/" id="wr"><i class="fa fa-calendar fa-fw"></i> 作息管理</a>
                        </li>
                        <li>
                            <a href="?/userinfo/" id="userinfo"><i class="fa fa-users fa-fw"></i> 员工信息</a>
                        </li>
                        <?php if($username == 'ch'): ?>
                            <li>
                        ...
                        <?php if($gid == 1): ?>
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="?/users/" id="users"> 用户管理</a>
                                    </li>
                                    <li>
                                        <a href="?/carlicrec/" id="carlicrec"> 车牌管理</a>
                                    </li>
                                    <li>
                                        <a href="?/vehiclerecord/" id="vehiclerecord"> 车辆通行记录</a>
                                    </li>
                                </ul>
                            </li>
                        <?php endif; ?>
