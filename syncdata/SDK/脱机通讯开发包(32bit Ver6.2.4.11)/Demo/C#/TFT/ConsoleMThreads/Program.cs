...
namespace ConsoleMThreads
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //{
            //    Device[i] = new WorkThread("192.168.1." + ((int)(1 + i)).ToString(), 4370);//You can custom the LAN Segment.
            //    ThreadPool.QueueUserWorkItem(Device[i].ThreadPoolCallBack);//Put the method into the queue to implement.
            //}
            Device[0] = new WorkThread("192.168.1.189", 4370);//You can custom the LAN Segment.
            ThreadPool.QueueUserWorkItem(Device[0].ThreadPoolCallBack);//Put the method into the queue to implement.
