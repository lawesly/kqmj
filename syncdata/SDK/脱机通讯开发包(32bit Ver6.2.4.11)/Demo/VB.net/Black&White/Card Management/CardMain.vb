...
#Region "Card Operation"
    ...
    Private Sub btnWriteCard_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnWriteCard.Click
        ...
        Dim idwEnrollNumber As Integer = Convert.ToInt32(cbUserID.Text.Trim())
        ...
        If AxCZKEM1.GetUserInfo(iMachineNumber, idwEnrollNumber, sName, sPassword, iPrivilege, bEnabled) = True Then
            ...
            For idwFingerIndex = 0 To iTmpToWrite - 1
                ...
                If AxCZKEM1.GetUserTmp(iMachineNumber, idwEnrollNumber, idwFingerIndex, byTmpData(0), iTmpLength) Then
                    iTmpCount += 1
        ...
        If AxCZKEM1.WriteCard(iMachineNumber, idwEnrollNumber, 0, byTmpData0(0), 1, byTmpData1(0), 2, byTmpData2(0), 3, byTmpData3(0)) = True Then 'write templates into card
    ...
    Private Sub btnGetStrCardNumber_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetStrCardNumber.Click
        ...
        While AxCZKEM1.GetAllUserInfo(iMachineNumber, idwEnrollNumber, sName, sPassword, iPrivilege, bEnabled) = True 'get user information from memory
    ...
    Private Sub btnSetStrCardNumber_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSetStrCardNumber.Click
        ...
        Dim idwEnrollNumber As Integer = Convert.ToInt32(txtUserID.Text.Trim())
        ...
        If AxCZKEM1.SetUserInfo(iMachineNumber, idwEnrollNumber, sName, sPassword, iPrivilege, bEnabled) = True Then 'upload the user's information(card number included)
            MsgBox("SetUserInfo,UserID:" + idwEnrollNumber.ToString() + " Privilege:" + iPrivilege.ToString() + " Cardnumber:" + sCardnumber + " Enabled:" + bEnabled.ToString(), MsgBoxStyle.Information, "Success")
        Else
            AxCZKEM1.GetLastError(idwErrorCode)
            MsgBox("Operation failed,ErrorCode=" & idwErrorCode.ToString(), MsgBoxStyle.Exclamation, "Error")
        End If
